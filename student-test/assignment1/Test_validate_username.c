...
void test_validate_my_username()
{
    ...
    TEST_ASSERT_NOT_NULL_MESSAGE(username_from_file, "Username file read returned NULL");
    TEST_ASSERT_EQUAL_STRING_MESSAGE(my_username(), username_from_file, "Username is Valid");
